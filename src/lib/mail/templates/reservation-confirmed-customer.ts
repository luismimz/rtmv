...
type ReservationConfirmedTemplateData = {
...
export function reservationConfirmedCustomerTemplate(
              ...
              >
                ...
                <tr>
                  <td style="padding:32px;">
                    <h1 style="margin:0 0 16px;font-size:28px;color:#1e3023;">
                      ¡Tu reserva está confirmada!
                    </h1>

                    <p style="margin:0 0 24px;line-height:1.6;">
                      Hola ${data.customerName}, tenemos tu mesa lista en
